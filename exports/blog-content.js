...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-build.2690+sha.be7c02c/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-build.2690+sha.be7c02c',    // all of these placeholder strings will be replaced by grunt's
...
},{"./controllers":3,"angular/angular":1}],3:[function(require,module,exports){
...
},{"./controllers/BlogAggregatorCtrl":4}],4:[function(require,module,exports){
